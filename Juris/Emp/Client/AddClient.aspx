<%@ Page ValidateRequest="false" Title="" Theme="Skin1" Language="C#" MasterPageFile="~/employee.Master"
    AutoEventWireup="true" CodeBehind="AddClient.aspx.cs" Inherits="Juris.Emp.Client.AddClient" %>
    ...
    <div style="width: 100%;">
        ...
        <div style="width: 55%;">
            ...
            <tr><td>
                ...
                <tr>
                    <td class="style1">
                        <asp:Label ID="lblSerTax1" runat="server" Visible="false" Text="Service Tax :"></asp:Label>
                    </td>
                    <td class="tdControl">
                        <asp:TextBox ID="txtSerTaxClient" runat="server" Visible="false">0</asp:TextBox><br />
                        <asp:CheckBox ID="chkbxAppCl" runat="server" Text="Approve Client" Visible="false"/>
                    </td>
                </tr>
            </table>
            <table align="center">
        ...
        <div style="width: 42%; position: absolute;  right: 200px; top: 150px">
        <table>
            <tr>
                    <td class="style1">
        ...
        <%----------------------------------------Right div------------------------------------%>
        <div style="visibility:hidden;width: 42%; position: absolute;  right: 100px; top: 180px;">
            <table>
                <tr>
                ...
                <tr>
                    <td class="tdLabel">
                        <asp:Label ID="Label26" Visible="false" runat="server" Text="Price :"></asp:Label>
                    </td>
                    <td class="tdControl">
                        <asp:TextBox ID="txtSerPrice"  Visible="false" runat="server" Text="0"></asp:TextBox>
                ...
                <asp:GridView ID="GdVwService" runat="server" AutoGenerateColumns="False" Width="100%">
                    <Columns>
                     ...
                     <ItemTemplate ><%#Eval("Price")%></ItemTemplate>
                        ...
                        <asp:BoundField DataField="Price" Visible="false" HeaderText="Price" InsertVisible="False" />
                    </Columns>
                </asp:GridView>
            </asp:Panel>
            <table class="table">
