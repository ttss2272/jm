<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" Theme ="Skin1" 
    CodeBehind="SelectProject.aspx.cs" Inherits="Juris.Admin.Project.SelectProject" %>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <asp:Label ID="Label1" runat="server" Text="From Date : "></asp:Label>
                            ...
                            <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtFromDate" ClearTime="True" DaysModeTitleFormat="dd/MM/yyyy"
                        ...
                        <td class="tdControl ">
                         <asp:Label ID="Label2" runat="server" Text="To Date : "></asp:Label>
                            ...
                            <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtToDate" ClearTime="True" DaysModeTitleFormat="dd/MM/yyyy"
                                                                Format="dd/MM/yyyy"  TodaysDateFormat="dd/MM/yyyy">
                            </asp:CalendarExtender>
                        </td>
                        <td >
