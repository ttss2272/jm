<%@ Page Title="" Language="C#" Theme="Skin1" MasterPageFile="~/admin.Master" AutoEventWireup="true"
    CodeBehind="AddEditWork.aspx.cs" Inherits="Juris.Admin.Project.AddEditWork" %>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tdControl">
                                                            ...
                                                            <asp:CalendarExtender ID="CEDate" runat="server" ClearTime="True" DaysModeTitleFormat="dd/MM/yyyy"
                                                                Format="dd/MM/yyyy" TargetControlID="txtDate" TodaysDateFormat="dd/MM/yyyy">
                                                            </asp:CalendarExtender>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="tdLabel">
                                                        <asp:Label ID="Label6" runat="server" Visible="false" Text="Pending Docs Rcsp :"></asp:Label>
                                                    </td>
                                                    <td class="tdControl">
                                                        <asp:CheckBox ID="ChkBxPDRcsp" Visible="false" runat="server" AutoPostBack="True" OnCheckedChanged="ChkBxPDRcsp_CheckedChanged" />
                                                        <asp:TextBox ID="txtPendingDocRcsp" Visible="false" runat="server" Enabled="False"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tdLabel" align="right">
                                                        <asp:Label ID="Label26" runat="server" Visible="false" Text="Final Report Sent :"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:CheckBox ID="ChkBxFRS" runat="server" Visible="false" AutoPostBack="True" OnCheckedChanged="ChkBxFRS_CheckedChanged" />
                                                        <asp:TextBox ID="txtFinalReportSent" Visible="false" runat="server" Enabled="False"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td class="tdLabel" align="right">
                                                        <asp:Label ID="Label29" runat="server" Text="Service Tax :"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtServiceTax" runat="server" AutoPostBack="True" Enabled="False">0</asp:TextBox>
                                                        <asp:RegularExpressionValidator ID="REVServiceTax" runat="server" ControlToValidate="txtServiceTax"
                                                            Display="Dynamic" ErrorMessage="*" ForeColor="Red" ToolTip="Enter Only Numbers."
                                                            ValidationExpression="[0-9.]{1,10}" ValidationGroup="SaveProject"></asp:RegularExpressionValidator>
                                                    </td>
                                                    <td class="tdLabel" align="right">
                                                        <asp:Label ID="Label22" runat="server" Text="Other Charges :"></asp:Label>
                                                    </td>
                                                    <td class="tdControl">
                                                        <asp:TextBox ID="txtOtherCharge" runat="server" AutoPostBack="true" OnTextChanged="txtOtherCharge_TextChanged">0</asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tdLabel" align="right">
                                                            <asp:Label ID="Label24" runat="server" Text="Total Amount :"></asp:Label>
                                                        </td>
                                                        <td class="tdControl">
                                                            <asp:TextBox ID="txtTotAmt" runat="server" Enabled="False">0</asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:RadioButton ID="rbNoIsDel" Checked="true" runat="server" GroupName="IsDeleted" 
                                                                Text="No" />
                                                            <asp:CheckBox ID="ChkBxApprovProject" runat="server" Text="Approve Project" />
                                                        </td>
                                                    </tr>
                                                </tr>
                                            </table>
