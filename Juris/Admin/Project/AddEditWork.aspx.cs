                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (Request.QueryString["ProjectId"] != null)
                    {
                        ...
                        foreach (GridViewRow gvrow in GVEmployees.Rows)
                        {
                            ...
                            if (gvrow.RowType == DataControlRowType.DataRow)
                            {
                                gvempid = Convert.ToInt32(gvrow.Cells[1].Text);
                        ...
                        foreach (GridViewRow gvrow in GVDocBoy.Rows)
                        {
                            ...
                            if (gvrow.RowType == DataControlRowType.DataRow)
                            {
                                gvdocboyid = int.Parse(gvrow.Cells[1].Text);
                        ...
                        foreach (GridViewRow gvrow in GVClerk.Rows)
                        {
                            ...
                            if (gvrow.RowType == DataControlRowType.DataRow)
                            {
                                gvclerkid = int.Parse(gvrow.Cells[1].Text);
                        ...
                        if (dr2.HasRows)
                        {
                            while (dr2.Read())
                            {
                                ...
                                foreach (GridViewRow gvrow in GVServices.Rows)
                                {
                                    ...
                                    if (gvrow.RowType == DataControlRowType.DataRow)
                                    {
                                        gvserviceid = int.Parse(gvrow.Cells[1].Text);
      ...
      */
        ...
        protected void setparameters()
        {
            try
            {
                ...
                dt_MISclient = Convert.ToDateTime("1990-01-01 00:00:00.000");
                ...
                dt_pendingdocumentsresp = Convert.ToDateTime(txtPendingDocRcsp.Text);
                dt_finalreportsent = Convert.ToDateTime(txtFinalReportSent.Text);
            ...
            try
            {
                ...
                foreach (GridViewRow gvrow in GVPapers.Rows)
                {
                    if (gvrow.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        if (ChkBxSelDoc.Checked)
                        {
                            ...
                            string Document = gvrow.Cells[2].Text;
                ...
                foreach (GridViewRow gvrow in GVEmployees.Rows)
                {
                    if (gvrow.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        {
                            int Empid = int.Parse(gvrow.Cells[1].Text);
                            string EmpCode = gvrow.Cells[2].Text;
                ...
                foreach (GridViewRow gvrow in GVClerk.Rows)
                {
                    if (gvrow.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        {
                            int Clerkid = int.Parse(gvrow.Cells[1].Text);
                            string ClerkName = gvrow.Cells[2].Text;
                ...
                foreach (GridViewRow gvrow in GVServices.Rows)
                {
                    if (gvrow.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        {
                            int Serviceid = int.Parse(gvrow.Cells[1].Text);
                            string Service = gvrow.Cells[2].Text;
                            decimal Price = decimal.Parse(gvrow.Cells[3].Text);
                ...
                foreach (GridViewRow gvrow in GVDocBoy.Rows)
                {
                    if (gvrow.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        {
                            int DocBoyid = int.Parse(gvrow.Cells[1].Text);
                            string DocumentBoy = gvrow.Cells[2].Text;
            ...
            try
            {
                ...
                foreach (GridViewRow gvrow in GVServices.Rows)
                {
                    ...
                    if (gvrow.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        {
                            decimal IniPrice = Convert.ToDecimal(gvrow.Cells[3].Text);
