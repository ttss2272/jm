<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" Theme="Skin1" AutoEventWireup="true"
    CodeBehind="ViewProjects.aspx.cs" Inherits="Juris.Admin.Project.ViewProjects" %>
                            ...
                            <table>
                                <tr>
                                    <td colspan="2" align="left">
                                        <asp:Label ID="lblCatchError" runat="server" ForeColor="Red"></asp:Label><br />
                                ...
                                <asp:GridView ID="GdVwSrchProjects" runat="server"  
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDate" runat="server" Text='<%#Eval("ProjectDate")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
